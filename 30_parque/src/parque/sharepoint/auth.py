...
Identico al patron ya usado en 01_servidor_chile/sharepoint/auth.py y
201_bot_salesforce/app/sharepoint/auth.py: 'requests' + endpoint v2 de
Microsoft identity platform, sin msal ni azure-identity, para mantener
consistencia con el resto del repositorio.
"""
