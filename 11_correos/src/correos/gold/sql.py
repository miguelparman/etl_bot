...
from bronze.mappings import COLUMNA_CONTROL_FECHA, TABLA_BANDEJAS
...
from silver.mappings import TABLA_REGISTRO_SILVER

SILVER = f"[{ESQUEMA_SILVER}].[{TABLA_REGISTRO_SILVER}]"
BANDEJAS = f"[{ESQUEMA_BRONZE}].[{TABLA_BANDEJAS}]"
