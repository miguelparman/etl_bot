"""Constantes de la capa BRONZE: tablas de destino en SQL Server
('CL_MOVIL') y las columnas esperadas de cada hoja de los 'Registro_*.xlsx'
consolidados desde '14 CORREOS' (ver consolidar.py)."""
...
# Silver y gold usan el mismo campo para su propia carga por periodo.
