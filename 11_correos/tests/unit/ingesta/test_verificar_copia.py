...
import ingesta.verificar_copia as verificar_copia_module
from comun.config import SharePointOrigenSettings
from ingesta.verificar_copia import verificar_copia
